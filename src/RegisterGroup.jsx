          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="modal-body">
              ...
              <input
                ...
                onChange={(e) =>
                  setForm({ ...form, policystatus: e.target.value })
                }
              />
              ...
              <input
                ...
                onChange={(e) =>
                  setForm({ ...form, premiumstart: e.target.value })
                }
              />
              ...
              <input
                ...
                onChange={(e) =>
                  setForm({ ...form, premiumend: e.target.value })
                }
              />
              ...
              <input
                ...
                onChange={(e) =>
                  setForm({ ...form, bandallowed: e.target.value })
                }
              />
